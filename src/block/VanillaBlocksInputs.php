...
final class VanillaBlocksInputs extends RegistrySource{
	...
	protected function setup() : void{
		...
		self::register("suspicious_gravel", fn(BID $id) => new SuspiciousGravel($id, "Suspicious Gravel", new Info(new BlockBreakInfo(0.25, ToolType::SHOVEL))), TileBrushableBlock::class);
		self::register("suspicious_sand", fn(BID $id) => new SuspiciousSand($id, "Suspicious Sand", new Info(new BlockBreakInfo(0.25, ToolType::SHOVEL))), TileBrushableBlock::class);
		...
		self::register("lever", fn(BID $id) => new Lever($id, "Lever", new Info(new BreakInfo(0.5), [Tags::NON_SOURCE_WATERLOGGABLE])));
