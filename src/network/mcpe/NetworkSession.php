...
class NetworkSession{
	...
	public function syncAbilities(Player $for) : void{
		...
		$layers = [
			new AbilitiesLayer(AbilitiesLayer::LAYER_BASE, $boolAbilities, $for->getFlightSpeedMultiplier(), $for->getFlightSpeedMultiplier() / Player::DEFAULT_FLIGHT_SPEED_MULTIPLIER, 0.1),
		];
	...
	public function syncAvailableCommands() : void{
		...
		$pk = AvailableCommandsPacketAssembler::assemble(array_values($commandData), $hardcodedEnums, $softEnums);
