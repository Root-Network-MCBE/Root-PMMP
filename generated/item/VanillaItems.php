...
final class VanillaItems{
	...
	private static Boat $_mACACIA_CHEST_BOAT;
	...
	private static Boat $_mBAMBOO_CHEST_RAFT;
	...
	private static Boat $_mBIRCH_CHEST_BOAT;
	...
	private static CookedCod $_mCOOKED_COD;
	...
	private static Boat $_mDARK_OAK_CHEST_BOAT;
	...
	private static Boat $_mJUNGLE_CHEST_BOAT;
	...
	private static Boat $_mOAK_CHEST_BOAT;
	...
	private static RawCod $_mRAW_COD;
	...
	private static Boat $_mSPRUCE_CHEST_BOAT;
	...
	private static function getInitAssigners() : array{
		return [
			...
			"acacia_chest_boat" => fn(Boat $v) => self::$_mACACIA_CHEST_BOAT = $v,
			...
			"bamboo_chest_raft" => fn(Boat $v) => self::$_mBAMBOO_CHEST_RAFT = $v,
			...
			"birch_chest_boat" => fn(Boat $v) => self::$_mBIRCH_CHEST_BOAT = $v,
			...
			"cooked_cod" => fn(CookedCod $v) => self::$_mCOOKED_COD = $v,
			...
			"dark_oak_chest_boat" => fn(Boat $v) => self::$_mDARK_OAK_CHEST_BOAT = $v,
			...
			"jungle_chest_boat" => fn(Boat $v) => self::$_mJUNGLE_CHEST_BOAT = $v,
			...
			"oak_chest_boat" => fn(Boat $v) => self::$_mOAK_CHEST_BOAT = $v,
			...
			"raw_cod" => fn(RawCod $v) => self::$_mRAW_COD = $v,
			...
			"spruce_chest_boat" => fn(Boat $v) => self::$_mSPRUCE_CHEST_BOAT = $v,
	...
	public static function ACACIA_CHEST_BOAT() : Boat{
	...
	public static function BAMBOO_CHEST_RAFT() : Boat{
	...
	public static function BIRCH_CHEST_BOAT() : Boat{
	...
	public static function COOKED_COD() : CookedCod{
		if(!isset(self::$_mCOOKED_COD)){ self::init(); }
		return clone self::$_mCOOKED_COD;
	}
	...
	public static function DARK_OAK_CHEST_BOAT() : Boat{
	...
	public static function JUNGLE_CHEST_BOAT() : Boat{
	...
	public static function MANGROVE_CHEST_BOAT() : Boat{
	...
	public static function OAK_CHEST_BOAT() : Boat{
	...
	public static function RAW_COD() : RawCod{
		if(!isset(self::$_mRAW_COD)){ self::init(); }
		return clone self::$_mRAW_COD;
	}
	...
	public static function SPRUCE_CHEST_BOAT() : Boat{
	...
	public static function TROPICAL_FISH() : TropicalFish{
		if(!isset(self::$_mTROPICAL_FISH)){ self::init(); }
		return clone self::$_mTROPICAL_FISH;
	}
